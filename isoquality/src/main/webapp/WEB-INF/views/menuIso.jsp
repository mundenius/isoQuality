...
<%@include file="fixed/navbar.jsp" %>
                  ...
                  <div class="col-1"></div>
                    <div class="col-10">
                        ...
                        <div class="col text-center">
                            <a type="button" class="btn btn-primary btn-lg btn-block" href="/contacto.html">Evaluación
                                Gratuita</a>
                        </div>
                        <br>
                ...
                <div class="container-card">
                    ...
                    <div id="tarjetasIso" class="card">
                        <figure>
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#myModalv1">
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Volver</button>
                                    <a type="button" class="btn btn-primary" href="/contacto.html">Evaluación Gratuita</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="tarjetasIso" class="card">
                        <figure>
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#myModalv2">
                    ...
                    <div class="modal fullscreen-modal fade" id="myModalv2" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-bs-dismiss="modal">Volver</button>
                                    <a type="button" class="btn btn-primary" href="/contacto.html">Evaluación
                                        Gratuita</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="tarjetasIso" class="card">
                        <figure>
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#myModalv3">
